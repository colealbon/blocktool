...
const slow_blockRangeToBlockCount = function blockRangeToBlockCount(blockrange) {
...
const slow_dateRangeToBlockCount = function* dateRangeToBlockCount(daterange) {
...
const slow_dateRangeToBlockHash = function dateRangeToBlockHash(daterange) {
...
const dateRangeToBlockHash = memoizee(slow_dateRangeToBlockHash);
...
const slow_blockHashToBlockHeader = function blockHashToBlockHeader(blockhash) {
    logger.silly({
...
const slow_blockHeaderToTime = function blockHeaderToTime(blockheader) {
    logger.silly({
...
const slow_guess = function guess(guessObj) {
    logger.silly({
        'slow_guess<-': {
            'guessObj': guessObj
        }
...
const slow_timeToBlockCount = function timeToBlockCount(targettime) {
    logger.debug({
...
//const timeToBlockCount = slow_timeToBlockCount;
...
const slow_txidToRawTransaction = function txidToRawTransaction(txid) {
...
const slow_txidToTransactionSignature = function txidToTransactionSignature(
    txid) {
...
const slow_vinItemToInputDetailItem = function vinItemToInputDetailItem(vinItem) {
    logger.silly({
...
const slow_vinToInputDetail = function vinToInputDetail(vin) {
...
const vinToInputDetail = memoizee(slow_vinToInputDetail, {
    maxAge: 30000
});
...
const slow_rawTransactionToInputDetail = function rawTransactionToInputDetail(
    rawtransaction) {
    logger.silly({
...
const slow_rawTransactionToTransactionSignature = function rawTransactionToTransactionSignature(
    rawtransaction) {
    logger.silly({
...
const rawTransactionToTransactionSignature =
    memoizee(slow_rawTransactionToTransactionSignature, {
        maxAge: 30000
    });

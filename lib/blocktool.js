...
const blockRangeToBlockCount = slow_blockRangeToBlockCount;
module.exports.blockRangeToBlockCount = blockRangeToBlockCount;

const dateRangeToBlockCount = function*(daterange) {
    logger.debug('dateRangeToBlockCount <-', {
        'daterange': daterange
    });
    typecheck.dateRangeGuard(daterange);
    const blockCountArr = dateRangeToBlockRange(daterange).then(function(blockrange) {
        return blockRangeToBlockCount(blockrange).then(function(blockCountArr) {
              return blockCountArr;
        });
    });
...
const dateRangeToTransactionSignature = function*(daterange) {
    // logger.debug('dateRangeToTansactionSignature <-', {
    //     'daterange': daterange
    // });
    // typecheck.dateRangeGuard(daterange);
    // return yield Promise.resolve(dateRangeToBlockCount(daterange)).then(function(blockCountArr) {
    //     return blockCountArr;
    // })
    //console.log(blockCountArr);
    //typecheck.arrOfIntGuard(blockCountArr);
    //return yield * blockCountArr;
...
module.exports.dateRangeToTransactionSignature =
    dateRangeToTransactionSignature;
...
module
    .exports.blockHeaderToTime = blockHeaderToTime;
